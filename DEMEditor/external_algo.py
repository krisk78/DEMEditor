...
from .qt_utils import set_parameter_enabled, StatusProgress
...
class ExternalAlgorithm(QgsProcessingAlgorithm):
    ...
    def post_processing(self, results: dict[str, Any]) -> str|None:
        ...
        progress: int = 0
        progress_bar = StatusProgress("Processing polygons...", progress)
        ...
        try:
            ...
            if algo_features.selection_mode is SelectionMode.RASTER:
                progress = 25
            if algo_features.selection_mode is SelectionMode.EXTENT:
                progress = 10
            progress_bar.update("Building selection set...", progress)
    ...
    def run_with_selection_raster(
        ...
        try:
            ...
            status_progress.update("Building selection layer...", 50)
            ...
            status_progress.update("Saving selection layer...", 75)
            ...
            status_progress.update(f"Launching {algo.value}...", 100)
    ...
    def run_with_extent(
        ...
        try:
            ...
            status_progress.update("Getting selection extent...", 20)
            ...
            status_progress.update("Building the clipped layer...", 30)
            ...
            status_progress.update("Saving the clipped layer...", 45)
            ...
            status_progress.update(f"Launching {algo.value}...", 55)
            ...
            status_progress.update("Processing result...", 65)
            ...
            status_progress.update("Injecting result in source raster...", 75)
            ...
            status_progress.update("Saving new layer...", 90)
